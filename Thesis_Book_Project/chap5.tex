...
\begin{figure}[htbp]
 \vspace{-2mm}
  \begin{center}
    \begin{tabular}{cc}
         \hspace{-5mm}
      \resizebox{70mm}{!}{\includegraphics[]{Runtime.png}} &
        \hspace{-5mm}
         \vspace{-2mm}
      \resizebox{70mm}{!}{\includegraphics[]{ServerQ.png}} \\
     \scriptsize{(a) \textsc{}\hspace{0mm}} & \scriptsize{(b) \textsc{}}\\
        \hspace{-5mm}
       \resizebox{70mm}{!}{\includegraphics{io_obs.png}} &
        \hspace{-5mm}
     \resizebox{70mm}{!}{\includegraphics{io_poi.png}} \\
...
%       \scriptsize{(e) \textsc{sum}\hspace{0mm}} & \scriptsize{(f) \textsc{max}}
        \end{tabular}
    \caption{Effect of Client's movement length  for Germany data  (a)query processing time and (b)Server Query (c)IO-obstacles (d)IO-POI}
...
% \vspace{-2mm}
 %%  \begin{tabular}{cc}
      %   \hspace{-5mm}
    %  \resizebox{70mm}{!}{\includegraphics[]{NaiveRuntime.png}} &
      %  \hspace{-5mm}
      %   \vspace{-2mm}
     % \resizebox{70mm}{!}{\includegraphics[]{NaiveServerQ.png}} \\
    % \scriptsize{(a) \textsc{}\hspace{0mm}} & \scriptsize{(b) \textsc{}}\\
     %   \hspace{-5mm}
      %  \resizebox{70mm}{!}{\includegraphics{NaiveServerQ.png}} &
      %  \hspace{-5mm}
...
%       \scriptsize{(e) \textsc{sum}\hspace{0mm}} & \scriptsize{(f) \textsc{max}}
      %  \end{tabular}
    %\caption{Effect of Alarm Range $r$  for Germany data (a) I/O(obstacle),(b)I/O(POI), (c)query processing time and (d)Server Query}
...
%       \scriptsize{(e) \textsc{sum}\hspace{0mm}} & \scriptsize{(f) \textsc{max}}
     %   \end{tabular}
  %  \caption{Effect of synthetic data set size  for Germany data (a) I/O(obstacle),(b)I/O(POI), (c)query processing time and (d)Server Query}
  %  \label{graph:ClientVelocity}
 % \end{center}
  % \vspace{-6mm}
%\end{figure}
